...
const LoginHeader = () => {
    return (<> <div className="flex items-center gap-x-3 justify-center">
                ...
                {state === 0 ? (
                    <form className="flex flex-col gap-y-6">
                        ...
                        <div className="flex justify-between text-gray-700 text-lg">
                            ...
                            <button className="text-[#c6252b]  cursor-pointer hover:underline text-[#c6252b"
                                onClick={() => setstate(2)}
                    ...
                    : state === 1 ? (
                        <form className="flex flex-col gap-y-6">
                            ...
                            {isRePassword && <div className="flex flex-row items-center gap-x-1">
                                <FaInfoCircle className="w-4 h-4 text-red-700" />
                                <h1 className="text-red-700">The password and confirmation password do not match.</h1>
                            </div>}
                        ...
                        : state === 2 ? (
                            <form className="flex flex-col gap-y-5">
                                ...
                                <p className="text-xl justify-start text-gray-700">Enter your email address, we'll send you instructions to reset your password.</p>
                                {/* Email Input */}
                                <div className="relative">
                                    <FaEnvelope className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 w-5 h-5" />
                                    <input
